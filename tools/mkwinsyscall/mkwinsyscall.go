...
var (
	...
	winio          = flag.Bool("winio", false, `import this package ("github.com/parallel-oss/go-winio")`)
...
func (src *Source) Generate(w io.Writer) error {
	...
	if *winio {
		src.ExternalImport("github.com/parallel-oss/go-winio")
	}
...
// Code generated by 'go generate' using "github.com/parallel-oss/go-winio/tools/mkwinsyscall"; DO NOT EDIT.
