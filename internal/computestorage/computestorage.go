...
import (
	...
	"github.com/parallel-oss/go-winio/internal/interop"
)

//go:generate go run github.com/parallel-oss/go-winio/tools/mkwinsyscall -output zsyscall_windows.go computestorage.go
